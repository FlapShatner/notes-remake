...
function Header() {
  ...
  return (
    <div className='fixed z-10 w-full max-w-5xl opacity-80 flex flex-row p-1 h-18 bg-gradient-to-r from-indigo-500 to-indigo-400 justify-between mix-blend-luminosity'>
      <Link to={'/'}>
